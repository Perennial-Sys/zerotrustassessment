...
function Test-Assessment-21879{
    ...
    try {
        ...
        $testResultMarkdown = '⚠️ Unable to query entitlement management policies. This may indicate that Entitlement Management is not enabled or configured in the tenant, or insufficient permissions to access the data.'
        $passed = $false
    }
